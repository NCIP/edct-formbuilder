...
/**
 * This interceptor is responsible for building the menu of breadcrumbs that is displayed for a given controller.
 * @author Oawofolu
 *
 */
public class MessageBundleInterceptor extends HandlerInterceptorAdapter {
	...
	private static Logger log = Logger.getLogger(MessageBundleInterceptor.class);
	...
	throws Exception {
	   ...
	   modelAndView.getModelMap().addAttribute( MESSAGE_MAP, resourceMessageSource.getMessages(request.getLocale()));
